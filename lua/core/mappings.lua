...
M.telescope = {
  ...
  n = {
    ...
    ["<leader>sa"] = { "<cmd> Telescope find_files find_command=fd,--type,f,--hidden,--no-ignore,--strip-cwd-prefix,--exclude=.git,--exclude=node_modules,--exclude=tmp,--follow <CR>", "Find all" },
    ...
    ["<leader>/"] = { "<cmd> Telescope live_grep search_dirs=% <CR>", "Find in current buffer" },
